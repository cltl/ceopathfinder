...
def check_score(input_ending):
    ...
    file_ending = ['.eval', '.eval.bl1S', '.eval.bl3S', '.eval.bl5S', '.eval.blANY', '.eval.ceo1S', '.eval.ceo3S', '.eval.ceo5S', '.eval.ceoANY', '.eval.nc1S', '.eval.nc3S', '.eval.nc5S', '.eval.ncANY']
...
def system_end():
    ...
    while True:
        ...
        try:
            ...
            print("Illegal value - system output must ends with one of the following values:  '.eval', '.eval.bl1S', '.eval.bl3S', '.eval.bl5S', 'eval.blANY', .eval.ceo1S','.eval.ceo3S', '.eval.ceo5S', '.eval.ceoANY', .eval.nc1S','.eval.nc3S', '.eval.nc5S', '.eval.ncANY'")
            return system_end()
